...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an Jennie management bot [✨](https://telegra.ph/Rishabh-Bhan-12-06)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    [
        InlineKeyboardButton(text="About Jennie Robot", callback_data="emiko_"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="➗ Add Jennie To Your Group ➗", url="t.me/JenneKim_1bot?startgroup=new"),
    ],
]
...
EMI_IMG = "https://telegra.ph/Rishabh-Bhan-12-06"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @Rishu_05 \
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        ...
        query.message.edit_text(
            ...
            "\nJoin My Support Group/Channel for see or report a problem on Jennie.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="https://t.me/English_chatting_speaking"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/Worldchattinggroupforall"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Rishabh", url="https://github.com/Rishabhbhan5"),
                    InlineKeyboardButton(text="TheHamkerCat", url="https://github.com/TheHamkerCat"),
                 ],
                 [
                    InlineKeyboardButton(text="Feri", url="https://github.com/FeriEXP"),
                    InlineKeyboardButton(text="Rishu", url="https://github.com/Rishabhbhansingh1"),
                 ],
                 [
